...
class AppSampleRouter:
    ...
    def __init__(self):
        ...
        @router.post(path="/pipeline-api/sample/crud",
                     tags=['PIPELINE-APIS : SAMPLE'],
                     summary='新增对象',
                     description='新增对象',
        ...
        @router.delete(path="/pipeline-api/sample/crud/{_id}",
                       tags=['PIPELINE-APIS : SAMPLE'],
                       summary='删除对象',
                       description='删除对象',
                       response_model=AssertResponse,
        ...
        @router.put(path="/pipeline-api/sample/crud",
                    tags=['PIPELINE-APIS : SAMPLE'],
                    summary='更新对象',
                    description='更新对象',
                    response_model=AssertResponse,
        ...
        @router.get(path="/pipeline-api/sample/crud/{_id}",
                    tags=['PIPELINE-APIS : SAMPLE'],
                    summary='查询对象',
                    description='查询对象',
        ...
        @router.get(path="/pipeline-api/sample/crud",
                    tags=['PIPELINE-APIS : SAMPLE'],
                    summary='查询分页',
                    description='查询分页',
                    response_model=Page,
